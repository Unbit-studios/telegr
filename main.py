...
def hack(_, msg):
    ...
    while(perc < 100):
        try:
            text = "👮‍ Guruhga xujum uyushtirilmoqda ..." + str(perc) + "%"
            msg.edit(text)
    ...
    msg.edit("🟢 Malumotlar saqlandi!")
    sleep(3)
 
    msg.edit("👽 Maxfiy Malumotlar qidirilmoqda ...")
    perc = 0
 
    while(perc < 100):
        try:
            text = "👽 Maxfiy Foydalanuvchilar topildi ..." + str(perc) + "%"
            msg.edit(text)
    ...
    msg.edit("🦖 Pentagon buzib kirildi!")
